...
As a commissioner,
I want to show current versus stale data,
so that I can trust what I am seeing.

## Acceptance Criteria

1. Given the leaderboard refresh is on schedule, when I view the leaderboard, then the system marks the data as current, and it uses a clear label or chip, not color alone.
2. Given the refresh cadence falls behind, when I view the leaderboard, then the system marks the data as stale, and it makes the freshness issue obvious, and it keeps the stale state readable on small screens.
...
- Story source: [Source: _bmad-output/planning-artifacts/epics.md#Story 3.4]
...
- _bmad-output/implementation-artifacts/3-4-show-current-versus-stale-data.md
