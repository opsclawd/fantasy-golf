...
1. Given I am signed in as a commissioner, when I access commissioner actions, then I can use admin controls available to the pool owner, and the actions are recorded for audit purposes.
2. Given I am signed in as a regular player, when I try to access commissioner-only actions, then the system blocks access, and the controls are hidden or disabled.
...
- _bmad-output/implementation-artifacts/1-5-perform-commissioner-only-actions.md
