...
As a commissioner,
I want to investigate scoring issues with admin tools,
so that I can understand what happened when results look wrong.

## Acceptance Criteria

1. Given I am signed in as a commissioner, when I open the admin investigation tools, then I can review refresh history and scoring events, and I can trace the current leaderboard back to stored inputs.
...
- _bmad-output/implementation-artifacts/5-2-investigate-scoring-issues-with-admin-tools.md
