...
As a player,
I want to view golfer detail information,
so that I can make informed pick decisions.

## Acceptance Criteria

1. Given golfers are available in the pool, when I open a golfer detail view, then I see the golfer's name, current score, and pool-relevant status, and the view loads quickly on mobile.
...
- Story source: [Source: _bmad-output/planning-artifacts/epics.md#Story 4.1]
...
- _bmad-output/implementation-artifacts/4-1-view-golfer-detail-information.md
