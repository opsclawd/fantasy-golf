...
As a player,
I want to provide a responsive, accessible pwa experience,
so that I can use it on desktop and mobile without a native app.

## Acceptance Criteria

1. Given I open the product on desktop or mobile, when I navigate the main flows, then the layout adapts to the screen size, and the app remains usable as an online-only PWA, and touch targets stay usable on mobile.
2. Given I use keyboard navigation or assistive tech, when I move through the app, then focus states and status changes remain perceivable, and the key flows remain accessible, and status chips, confirmation states, and errors remain legible on small screens.
...
- Story source: [Source: _bmad-output/planning-artifacts/epics.md#Story 5.5]
...
- _bmad-output/implementation-artifacts/5-5-provide-a-responsive-accessible-pwa-experience.md
